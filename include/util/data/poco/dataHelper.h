...
public:
    ...
    virtual int getPlayerMoney(const char * uuid) = 0;

    virtual void addPlayerMoney(const std::string& uuid,const int& addMoney) = 0;
    virtual void addPlayerMoney(const char* uuid, const int & addMoney) = 0;

    virtual void setPlayerMoney(const std::string& uuid,const int& money) = 0;
    virtual void setPlayerMoney(const char* uuid, const int &money) = 0;
};
